...
public class Heuristics {
    ...
    public Heuristics(){
        ...
        lightmap.put("GF1", new String[]{"A1", "A2", "A3", "A4", "AB1", "AB2", "B2", "B3", "BB1", "C1", "D3"});
        lightmap.put("GF2", new String[]{"A1", "A2", "A3", "A4", "AB1", "AB2", "B2", "B3", "BB1", "C1", "D3"});
        lightmap.put("GV1", new String[]{"A1", "A2", "A3", "A4", "AB1", "AB2"});
        lightmap.put("GV2", new String[]{"B2", "B3", "C1", "D3", "BB1"});
    ...
    public Stoplichten algo(HashMap<String, Integer> verkeermap){
        ...
        {
            System.out.print(i + ": " + verkeermap.get(i));
            switch (i){
                case "A1":
                {
